...
-- Thời gian đã tạo: Th5 02, 2021 lúc 08:58 AM
...
(1, 'Trang chủ', '<li class=\"nav-item \"><a href=\"./\" class=\"nav-text-style nav-padding is-active\">Trang Chủ</a></li>', NULL),
(2, 'Giới thiệu', '<li class=\"nav-item \"><a href=\"./?action=page&type=gioi_thieu\" class=\"nav-text-style nav-padding is-active\">Giới thiệu</a></li>', NULL),
(3, 'Dấu ấn công trình', '<li class=\"nav-item \"><a href=\"./?action=product&type=dau_an\" class=\"nav-text-style nav-padding is-active\">Dấu ấn công trình</a><ul class=\"dropdown\"><li><a href=\" ./?action=product&type=dau_an&id=12\" class=\"nav-text-style-1\">nguyen oc cho</a></li><li><a href=\" ./?action=product&type=dau_an&id=11\" class=\"nav-text-style-1\">DỊCH VỤ CUNG CẤP</a></li></ul></li>', NULL),
(4, 'Mẫu thiết kế', '<li class=\"nav-item \"><a href=\"./?action=product&type=thiet_ke\" class=\"nav-text-style nav-padding is-active\">Mẫu thiết kế</a><ul class=\"dropdown\"><li><a href=\" ./?action=product&type=thiet_ke&id=12\" class=\"nav-text-style-1\">nguyen oc cho</a></li><li><a href=\" ./?action=product&type=thiet_ke&id=11\" class=\"nav-text-style-1\">DỊCH VỤ CUNG CẤP</a></li></ul></li>', NULL),
(5, 'Dự án', '<li class=\"nav-item \"><a href=\"./?action=post&type=du_an\" class=\"nav-text-style nav-padding is-active\">Dự án</a></li>', NULL),
(6, 'Tin tức', '<li class=\"nav-item \"><a href=\"./?action=post&type=tin_tuc\" class=\"nav-text-style nav-padding is-active\">Tin tức</a></li>', NULL),
(7, 'Liên hệ', '<li class=\"nav-item \"><a href=\"./?action=page&type=lien_he\" class=\"nav-text-style nav-padding is-active\">Liên hệ</a></li>', NULL),
(8, 'Xưởng sản xuất', '<li class=\"nav-item \"><a href=\"./?action=page&type=xuong_san_xuat\" class=\"nav-text-style nav-padding is-active\">Xưởng sản xuất</a></li>', NULL);
...
(94, 'Anh óc chó', 'Chuẩn siêu cấp vip pro', '2021-04-15', 'http://reiwa.local/public/images/ReiwaHouse_logo_final.svg', 'author', 6, 3, 1),
(95, 'Anh óc chó', 'Chuẩn siêu cấp vip pro', '2021-04-15', 'http://reiwa.local/public/images/ReiwaHouse_logo_final.svg', 'author', 5, 4, 1),
(96, 'Anh óc chó', 'Chuẩn siêu cấp vip pro', '2021-04-15', 'http://reiwa.local/public/images/ReiwaHouse_logo_final.svg', 'author', 6, 9, 1),
