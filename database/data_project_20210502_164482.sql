...
-- Thời gian đã tạo: Th5 02, 2021 lúc 09:59 AM
...
INSERT INTO `dropdown` (`id`, `url`, `content`, `navbar_id`) VALUES
(1, './?action=product&type=dau_an&id=12', 'nguyen oc cho', 3),
(2, './?action=product&type=dau_an&id=11', 'DỊCH VỤ CUNG CẤP', 3),
(3, './?action=product&type=thiet_ke&id=12', 'nguyen oc cho', 4),
(4, './?action=product&type=thiet_ke&id=11', 'DỊCH VỤ CUNG CẤP', 4);
...
(1, 'Trang chủ', './'),
(2, 'Giới thiệu', './?action=page&type=gioi_thieu'),
(3, 'Dấu ấn công trình', './?action=product&type=dau_an'),
(4, 'Mẫu thiết kế', './?action=product&type=thiet_ke'),
(5, 'Dự án', './?action=post&type=du_an'),
(6, 'Tin tức', './?action=post&type=tin_tuc'),
(7, 'Liên hệ', './?action=page&type=lien_he'),
(8, 'Xưởng sản xuất', './?action=page&type=xuong_san_xuat');
